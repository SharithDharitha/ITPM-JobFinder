...
const CompanyLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("uID", res.data.company._id);
      localStorage.setItem("name", res.data.company.name);
      localStorage.setItem("address", res.data.company.address);
      localStorage.setItem("email", res.data.company.email);
      localStorage.setItem("permissionLevel", res.data.company.permissionLevel);
      navigate("/company");
